...
impl BeaconRepo {
    ...
    pub async fn variant_exists(&self, dataset_id: &str, chromosome: &str, start: i64, end: i64) -> Result<bool> {
    ...
    pub async fn variant_count(&self, dataset_id: &str, chromosome: &str, start: i64, end: i64) -> Result<i64> {
