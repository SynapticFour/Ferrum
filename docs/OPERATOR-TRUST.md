...
- Optional Passport clearinghouse: `--features clearinghouse` (gateway `external-auth`) pulls `ga4gh-clearinghouse` from GitHub (`ga4gh-infra` `e43bf08…`, intended tag `ga4gh-infra-v0.2.2`).
